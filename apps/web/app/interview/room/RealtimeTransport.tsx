  ...
  useEffect(() => {
    ...
    async function connect() {
      ...
      try {
        ...
        const onConnectionQualityChanged = (...args: unknown[]) => { const quality = String(args[1] ?? args[0] ?? "good").toLowerCase(); const normalized: ConnectionQuality = quality.includes("poor") || quality.includes("lost") ? "poor" : quality.includes("excellent") ? "excellent" : "good"; setQuality(normalized); };
