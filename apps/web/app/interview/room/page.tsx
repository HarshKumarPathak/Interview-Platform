...
export default function InterviewRoomPage() {
  ...
  async function submitAnswer() {
    ...
    await fetch("/api/interviews/turns", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ interviewId, speaker: "candidate", content: text, metadata: { question_index: questionMeta?.question_index ?? answerCount, stage: questionMeta?.stage, response_to_role: questionMeta?.role } }) });
    ...
    setQuestion(ai.question); setQuestionMeta(ai); setAnswer("");
