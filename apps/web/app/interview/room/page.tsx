...
export default function InterviewRoomPage() {
  ...
  useEffect(() => {
    async function start() {
      ...
      } catch (error) { console.error(error); const fallback = "Tell me about a project you are most proud of and the impact you had on it."; setQuestion(fallback); setQuestionMeta({ stage: "intro", question_index: 0, role: "technical_interviewer", source: "fallback" }); setLoading(false); speakQuestion(fallback); }
    }
    void start();
