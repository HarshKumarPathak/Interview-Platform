...
export default function Home() {
  return (
    <main>
      ...
      <section className="cta container"><div><div className="eyebrow">Your next interview starts here</div><h2>Be ready when the real interviewer asks.</h2></div><Link href="/login" className="button button-primary button-large">Start practicing <span>→</span></Link></section>
