...
type Interview = { type: string; difficulty: string; duration_minutes: number; language: string; panel_size: number; status: string; started_at: string | null; completed_at: string | null; recording_status: string; recording_path: string | null };
